...
Instantaneous **power flow** for a circuit is configured in the **Optional monitoring** section (not on the main part of the circuit form). See [Optional monitoring](optional-monitoring/).
...
See [Optional monitoring](optional-monitoring/) and [Additional readings](optional-monitoring/additional-readings.md).
