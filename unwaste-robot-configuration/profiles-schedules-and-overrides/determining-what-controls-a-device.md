...
* **Surplus** — Surplus mode was applied because [Surplus mode](../connection.md#surplus-mode) is enabled, export/import conditions were met, and the price-based mode was not Boost
