...
This default behavior applies to **all managed devices** unless it is modified by additional mechanisms described later in this article, such as profiles, schedules, overrides, or **Surplus mode** on the connection (for PV surplus — see [Connection](../connection.md#surplus-mode)).
...
So, making it a short rule of thumb:  Overrides > Schedules > Default (price + surplus)
