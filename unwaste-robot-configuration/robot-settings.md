...
See [Initial configuration](../unwaste-for-home-assistant/initial-configuration.md) for the first-run workflow.
...
See [Local installation](../unwaste-for-home-assistant/local-installation.md) for add-on installation steps.
