...
* Production and storage are *not* part of `energyUsedChildren` directly, because they affect the energy balance via `energyProduced`, `energyStored`, and `energyRetrieved` in Step 2.
...
## Step 3: Total energy consumption for a circuit (`energyUsedTotal`)
 ...
 ![](../.gitbook/assets/Inner%20Workings_9d18a379-deff-4f9c-849c-9060c5912e2c_węzeł.png " =562x370")
...
`energyUsedThisLevel = energyUsedTotal - energyUsedChildren`
 ...
 ![](../.gitbook/assets/Inner%20Workings_2947b528-b993-4138-a023-4bb51941d03a_węzeł2.png " =579x370")
