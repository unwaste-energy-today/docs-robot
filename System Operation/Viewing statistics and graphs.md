...
!\[]\(../.gitbook/assets/System Operation\_bd89b27c-16e5-4ba4-ab56-8e8d444c417e\_Screenshot\_stats\_button.png " =200x195")
...
In the **Select data** field, pick one or more metrics. Available options depend on what readings are configured for that element (including [Optional monitoring](<../Configuration/Optional monitoring.md>) and [Additional readings](<../Configuration/Additional readings.md>)).
...
!\[]\(../.gitbook/assets/System Operation\_7ada579a-de8f-41ce-a4ac-ba259d8b257e\_Screenshot\_graphs\_for\_aggregated.png " =1240x608")
