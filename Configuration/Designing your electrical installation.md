...
* Your devices, sensors, and integrations must already be correctly configured in **Home Assistant**.
...
* **Connection**\nRepresents a physical connection to the power grid and defines energy prices (tariffs) and forecasts. Currently, the system only supports electrical connections. In the future, support for other connections, such as gas connections, is planned.
* **Circuit**\nRepresents a part of the electrical installation where energy flows are measured.
* **Production source**\nRepresents devices that generate electricity (for example, a PV inverter).
* **Energy storage**\nRepresents devices that can store electrical energy (for example, a battery).
* **Device**\nRepresents an energy consumer that can be monitored and optionally controlled.

These elements form a **tree structure** called the *installation graph*.
...
From the top navigation, select **Design**.
 ...
 ![](../.gitbook/assets/Configuration_20352e3f-e09f-438f-9480-6569edeb83de_Screenshot_Design.png " =512x67")
...
In an empty Design dashboard, a **plus (+) button** is visible.
 ...
 ![](../.gitbook/assets/Configuration_dcffe780-26d9-4d37-a037-a81800f4ce70_Screenshot_Adding_connection.png " =121x143")

When you hover over it, available connection types are shown.

 ![](../.gitbook/assets/Configuration_34b473e1-8040-4fac-8e09-dd7828d92aa1_Screenshot_Adding_connection_electric.png " =244x234")
...
When you hover over elements in the installation graph, additional icons appear.
 ...
 ![](../.gitbook/assets/Configuration_1bec4cfd-8c3c-47b2-b8f4-7a3458ee2932_Screenshot_graph_edit_button.png " =200x155")

Visible actions:

* **Edit icon**\nOpens configuration of the selected element.
* **Schedule icon (devices only)**\nAllows you to configure schedules for controllable devices.
...
* devices grouped by location or function
 ...
 ![](../.gitbook/assets/Configuration_a9ec5379-00dd-4f20-898a-aaea5cedd8d2_Screenshot_advanced_example.png " =1394x677")

This example is shown for inspiration.\nYour installation does not need to be this detailed to work correctly.
