...
* **Monitoring alerts** — List of all monitoring alerts defined for this connection (Element, Reading, link to details). See [Monitoring alerts](<Monitoring alerts.md>).
