...
See [Hardware requirements](../installation-for-home-assistant/hardware-requirements.md) for details.

***

### Installation Steps

1. **Install the add-on** — Follow [Local installation](../installation-for-home-assistant/local-installation.md).
2. **Initial configuration** — Complete onboarding and [Robot settings](<../Configuration/Robot settings.md>). See [Initial configuration](../installation-for-home-assistant/initial-configuration.md).
3. **Connect devices in Home Assistant** — Integrate meters and controllable devices before configuring Unwaste. See [Connecting devices](../installation-for-home-assistant/connecting-devices.md).
